...
if (isset($idAnn)) {
    ...
    $annonce = Annonce::getAnnonce(Connection::getConn(), $idAnn);
    if ($annonce == null) {
                            ...
                            <div class="row my-4">
                                <div class="col">
                                    <div class="container d-flex justify-content-center align-items-center">
                                        <img class="img-fluid" style="height: 400px" src="data:image/png;base64,<?= base64_encode($annonce->getPhoto()) ?>"
                            ...
                            <div class="row my-4">
                                <div class="col">
                                    <div class="container d-flex justify-content-around align-items-center">
                                        <a href="/grant-annonce/<?= $idAnn ?>" class="btn bg-kyaaf-blue-gradient flex-grow-1 mx-4 text-light">Valider</a>
                                        <a href="/gestion-annonce" class="btn btn-light flex-grow-1 mx-4">Ignorer</a>
                                        <a href="/deny-annonce/<?= $idAnn ?>" class="btn bg-kyaaf-blue-gradient flex-grow-1 mx-4 text-light">Rejeter</a>
                                    </div>
                                </div>
                            </div>
                        </div>
