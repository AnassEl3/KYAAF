                        ...
                        <div class="container-fluid">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item  d-flex justify-content-between align-items-centers activated my-2 p-2">
                                    <img class="img-fluid" src="/assets/img/gestionBlue.svg" width="30px" height="30px"
                                         alt="ic">
                                    <a class="fw-bold nav-link text-primary small" href="/gestion-annonce">Gestion des
                                        annonces</a>
                                </li>
                                <li class="nav-item d-flex justify-content-between align-items-center not-activated my-2 p-2">
                        ...
                        <div class="container-fluid">
                            <div class="m-2 row prime-heading-card">
                                <div class="col d-flex flex-row justify-content-around align-items-center">
                                    <p class="display-6 fw-normal">Nombre d'annonces en attente</p>
                                    <p class="display-4 text-kyaaf-blue fw-bold"><?= Annonce::getNbrPendingAnnonces(Connection::getConn()) ?></p>
                                </div>
                            </div>
                            <div class="m-2 row">
                                <div class="col">
                                    <ul class="list-group">
                                        <?php
                                        $types = Annonce::getPendingAnnonces(Connection::getConn());
                                        foreach ($types['critical'] as $annonce) { ?>
                                            <li class="my-2 list-item-perso-critical p-3 fw-bold d-flex justify-content-between align-items-center position-relative">
                                                ...
                                                <div class="d-flex flex-row">
                                                    <a class="btn btn-outline-success"
                                                       href="/grant-annonce/<?= $annonce->getIdAnn() ?>">Valider</a>
                                                    <a class="btn btn-outline-danger mx-2"
                                                       href="/deny-annonce/<?= $annonce->getIdAnn() ?>">Rejeter</a>
                                                    <a class="btn btn-outline-primary"
                                                       href="/gestion-annonce/<?= $annonce->getIdAnn() ?>">Voir</a>
                                                </div>
                                            </li>
                                            <?php
                                        }
                                        ...
                                        <?php
                                        $types = Annonce::getPendingAnnonces(Connection::getConn());
                                        foreach ($types['warning'] as $annonce) { ?>
                                            <li class="my-2 list-item-perso-alert p-3 fw-bold d-flex justify-content-between align-items-center position-relative">
                                                <div class="position-absolute date-zone"
                                                     style="border: #7f7fa7 2px solid; left: 5px; top: -5px; background-color: #dbdbea; color: #7f7fa7; border-radius: 4px; padding: 0 4px">
                                                    Il y'a <?= $annonce->getAgeAnn() ?> jours
                                                </div>
                                        ...
                                        <?php
                                        $types = Annonce::getPendingAnnonces(Connection::getConn());
                                        foreach ($types['good'] as $annonce) { ?>
                                            <li class="my-2 list-item-perso-good p-3 fw-bold d-flex justify-content-between align-items-center position-relative">
                                                <div class="position-absolute date-zone"
                                                     style="border: #7f7fa7 2px solid; left: 5px; top: -5px; background-color: #dbdbea; color: #7f7fa7; border-radius: 4px; padding: 0 4px">
                                                    Il y'a <?= $annonce->getAgeAnn() ?> jours
                                                </div>
