                        ...
                        <div class="container-fluid">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item d-flex justify-content-between align-items-center activated my-2 p-2">
                                    <img class="img-fluid" src="/assets/img/expiredBlue.svg" width="30px" height="30px"
                                         alt="ic">
                                    <a class="fw-bold nav-link text-primary small" href="/annonce-expiree">Annonces
                                        expirées</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="container-fluid">
                            <div class="m-2 row prime-heading-card">
                                <div class="col d-flex flex-row justify-content-around align-items-center">
                                    <p class="display-6 fw-normal">Nombre d'annonces expirées</p>
                                    <p class="display-4 text-kyaaf-blue fw-bold"><?= Annonce::getNbrExpiredAnnonces(Connection::getConn()) ?></p>
                                </div>
                            </div>
                            <div class="m-2 row">
                                <div class="col">
                                    <ul class="list-group">
                                        <?php foreach (Annonce::getExpiredAnnonces(Connection::getConn()) as $annonce): ?>
                                            <li class="my-2 list-item-perso-expired px-3 py-4 fw-bold d-flex justify-content-between align-items-center position-relative">
